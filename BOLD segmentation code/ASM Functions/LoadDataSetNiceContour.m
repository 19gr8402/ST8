function [Vertices,Lines,I]=LoadDataSetNiceContour(I,p,nBetween,verbose)
...
%[p.I, ~, ~] = AllMuscleSegmentation(p.I,false);
%p.I = ExternalForceImage2D(p.I,Options.Wline, Options.Wedge, Options.Wterm,Options.Sigma1);
%p.I = ExternalForceImageSJ(p.I);
%p.I(I.IBinary == 0) = 1;
...
if(verbose), plot(pointsy,pointsx,'b'); end %imshow(p.I,[]), hold on;

% For making binary
%binarySegment = poly2mask(pointsy,pointsx,512,512);
...
if(verbose), drawnow('expose'); hold on; end
