...
% efter load af vores workspace med MRI billlederne og manuelt segmenteret
close all
clearvars -except Subject manSegS9_1_r2 testimage manSegS_s1_r2
%% read, show and initial contour:
antalSubjects = 31;
P = cell(antalSubjects, 1);
