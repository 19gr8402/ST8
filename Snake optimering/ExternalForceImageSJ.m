function Eextern = ExternalForceImageSJ(I,b)
...
subplot(2,2,1)
imshow(Ephase)
title('E_{phase}', 'Interpreter', 'tex')
subplot(2,2,2)
imshow(Eedge)
title('E_{edge}', 'Interpreter', 'tex')
subplot(2,2,3)
imshow(Eterm)
title('E_{term}', 'Interpreter', 'tex')
subplot(2,2,4)
imshow(Eextern)
title('E_{Extern}', 'Interpreter', 'tex')
end
