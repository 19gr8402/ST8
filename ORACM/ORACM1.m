%function [time,itr] = ORACM1(Img,show)
    ...
    if show, 
        ...
        title(['ORACM1 : ',int2str(itr),'th iteration, the total area of the object:',int2str(abs(Area2))]);axis off; 
    end
    tic    
